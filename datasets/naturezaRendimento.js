function createDataset(fields, constraints, sortFields) {
    try {
        ...
        var query = "";
        query += "SELECT IDNATRENDIMENTO, CODNATRENDIMENTO, DESCRICAORENDIMENTO ";
        query += "FROM DNATUREZARENDIMENTO ";
        query += "ORDER BY CAST(IDNATRENDIMENTO AS INT)";
        ...
        log.error("Erro ao executar Dataset naturezaRendimento: " + mensagem);
