...
function bloquearTudoInicio() {
  ...
  containers.forEach(function (container) {
    ...
    $container.find("input:not([type='hidden']):not([type='checkbox']):not([type='radio']), textarea")
      .prop("readonly", true)
      .prop("disabled", false);
    ...
    $container.find(".upload-area")
      .addClass("disabled-upload")
      .off("click");
  });
}
function habilitarTudoInicio() {
  ...
  containers.forEach(function (container) {
    ...
    $container.find("input:not([type='hidden']), select, textarea")
      .prop("disabled", false)
      .prop("readonly", false)
      .removeClass("campo-bloqueado");

    $container.find(".upload-area")
      .removeClass("disabled-upload");
  });
